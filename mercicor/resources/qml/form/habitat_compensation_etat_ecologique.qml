...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorField index="72" showLabel="1" name="compensation_nom"/>
    <attributeEditorField index="74" showLabel="1" name="compensation_coeff_risque"/>
    <attributeEditorField index="75" showLabel="1" name="compensation_coeff_delais"/>
    <attributeEditorField index="76" showLabel="1" name="scenario_nom"/>
    ...
    <attributeEditorContainer visibilityExpression="" groupBox="0" showLabel="1" visibilityExpressionEnabled="0" name="Notes &amp; Scores" columnCount="2">
      <attributeEditorContainer visibilityExpression="" groupBox="1" showLabel="1" visibilityExpressionEnabled="0" name="Compensation" columnCount="1">
  ...
  <editable>
    ...
    <field name="compensation_coeff_delais" editable="0"/>
    <field name="compensation_coeff_risque" editable="0"/>
    <field name="compensation_id" editable="1"/>
    <field name="compensation_nom" editable="0"/>
    <field name="compensation_scenario_id" editable="0"/>
    ...
    <field name="scenario_gain_ben" editable="0"/>
    <field name="scenario_gain_bsd" editable="0"/>
    <field name="scenario_gain_bsm" editable="0"/>
    <field name="scenario_gain_man" editable="0"/>
    <field name="scenario_gain_mercicor" editable="0"/>
    <field name="scenario_gain_pmi" editable="0"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="compensation_coeff_delais"/>
    <field labelOnTop="0" name="compensation_coeff_risque"/>
    <field labelOnTop="0" name="compensation_id"/>
    <field labelOnTop="0" name="compensation_nom"/>
    <field labelOnTop="0" name="compensation_scenario_id"/>
    ...
    <field labelOnTop="0" name="scenario_gain_ben"/>
    <field labelOnTop="0" name="scenario_gain_bsd"/>
    <field labelOnTop="0" name="scenario_gain_bsm"/>
    <field labelOnTop="0" name="scenario_gain_man"/>
    <field labelOnTop="0" name="scenario_gain_mercicor"/>
    <field labelOnTop="0" name="scenario_gain_pmi"/>
  ...
  <widgets>
    <widget name="compensation_habitat_compensation_etat_ecologique-compensation">
      <config type="Map">
        <Option type="QString" value="" name="nm-rel"/>
      </config>
    </widget>
    <widget name="habitat_compensation_etat_ecologique-habitat">
      <config type="Map">
        <Option type="QString" value="" name="nm-rel"/>
      </config>
    </widget>
